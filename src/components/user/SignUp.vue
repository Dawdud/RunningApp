    ...
    <div class="login__content">
      <form action class="form" @submit.prevent>
        ...
        <div class="form__group--signup">
          ...
          >
          <p
            v-if="!$v.signupForm.email.email"
            class="invalid__input--inf"
          >Please provide a valid email adress.</p>
          <p
            v-if="!$v.signupForm.email.required && clickSumbit"
            class="invalid__input--inf"
        ...
        <div class="form__group--signup">
          ...
          >
          <p
            v-if="!$v.signupForm.password.required && clickSumbit"
            class="invalid__input--inf"
          >This field is required.</p>
        </div>
